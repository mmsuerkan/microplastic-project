...
# =============================================
# OTOMATİK PARÇACIK TAKİP SİSTEMİ
...
def auto_track_particle(video_path, output_dir="output_results", show_video=True, debug=False):
    ...
    # PARAMETRELER
    # =============================================
    # Silindir bolgesi (parcacik burada duser)
    # Bu degerler videonuza gore ayarlanabilir
    CYLINDER_LEFT = int(width * 0.25)
    CYLINDER_RIGHT = int(width * 0.75)
    ...
    while True:
        ...
        if show_video:
            ...
            cv2.imshow("Auto Tracking", display)
